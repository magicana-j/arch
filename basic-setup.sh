...
sudo pacman -S --needed gparted pacman-contrib neovim vim nano less timeshift htop gtop fastfetch neofetch wget curl unzip zip p7zip xarchiver bash-completion
