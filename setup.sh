...
sudo pacman -S --needed noto-fonts-{cjk, extra, configtool}
...
sudo pacman -S --needed pacman-contrib neovim vim nano less timeshift fastfetch neofetch wget curl unzip zip p7zip
